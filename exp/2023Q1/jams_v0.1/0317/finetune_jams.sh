...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_ms.py \
    -c exp/2023Q1/jams_v0.1/0317/configs/Baker_LJSpeech_MuSha0914_RxEnhancedV5_AISHELL3_Mita1022/tuning_jams_rx/train_full_sdp.json \
    -m exp/2023Q1/jams_v0.1/0317/tuning_jams_rx_full_sdp \
