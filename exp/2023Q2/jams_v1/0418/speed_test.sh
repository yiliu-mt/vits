...
# train
CUDA_VISIBLE_DEVICES=3,4,5,6 python train_ms.py \
    -c exp/2023Q2/jams_v1/0418/configs/Baker_LJSpeech_MuSha0914_RxEnhancedV5_AISHELL3_Mita1022/tuning_jams/speed_test.json \
    -m speed_test \
