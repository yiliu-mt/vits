...
CUDA_VISIBLE_DEVICES=4,5,6,7 python train_ms.py \
    -c exp/2023Q2/jams_v1/0419/configs/Baker_LJSpeech_MuSha0914_RxEnhancedV5_AISHELL3_Mita1022/tuning_jams_mos5/train_mos5_full_sdp.json \
    -m exp/2023Q2/jams_v1/0419/tuning_jams_mos5_full_sdp \
