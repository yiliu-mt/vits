...
python tools/generate_vits_data.py \
    --train_txt_fpath train_jams_haitian.txt \
    --test_txt_fpath val.txt \
    --remove_silence true \
    --use_sid \
    -p /nfs2/yi.liu/src/jams_exp/TTS-FastSpeech-freeze/exp/2023Q2/jams_v1.3/0504/config/Baker_LJSpeech_MuSha0914_AISHELL3_Mita1022_Jams0423/tuning_jams_all_from_20w/tuning_jams_haitian_from_10w/preprocess.yaml \
    -o /data3/jams_v1.3_0506/vits/jams_haitian/preprocessed_data
