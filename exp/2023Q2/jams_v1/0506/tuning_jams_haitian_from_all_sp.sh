...
# train
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python train_ms.py \
    -c exp/2023Q2/jams_v1/0506/configs/Baker_LJSpeech_MuSha0914_AISHELL3_Mita1022_Jams0423/tuning_jams_haitian_from_all_sp/train_jams_haitian_from_all_sp.json \
    -m exp/2023Q2/jams_v1/0506/Baker_LJSpeech_MuSha0914_AISHELL3_Mita1022_Jams0423/tuning_jams_all_full_sdp/tuning_jams_haitian_from_all_sp \
